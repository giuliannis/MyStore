...
test('Escolher a cor do produto para compra', async ({ page }) => {
    ...
    await loja.escolherABlusaDeCorBranca();
    await loja.adicionarItemAoCarrinho();

    //Então será possível comprar o produto em uma das cores disponíveis
    await loja.verificarSeACorDoProdutoAdicionaEhBranca();
});